...
# Script to open the remote URL of a Git repository in the browser
# Usage: git-web [remote-name]

set -e

usage() {
    echo "Usage: git-web [remote-name]"
    echo "  remote-name: Name of the remote (default: origin)"
    echo "Example: git-web"
    echo "Example: git-web origin"
    echo "Example: git-web upstream"
}
